          ...
          child: FractionallySizedBox(
            ...
            child: Column(
              children: [
                SizedBox(height: 20),
                Container(
                  child: Text('Введите номер телефона:'.tr, style: TextStyle(
                    color: Colors.black,
                    fontSize: 24,
                ...
                SizedBox(height: 10),
                Container(
                  child: Text('Ваш номер телефона будет использоваться для входа в аккаунт'.tr, style: TextStyle(
                ...
                ElevatedButton(
                  ...
                  onPressed: () {Navigator.pushNamed(context, '/signupstepsecond');},
                )
              ],
            )
          )
